...
<table cellpadding="5" cellspacing="8" border="0" width="100%" class="fs12">
    <tbody><tr>
        ...
        <td width="auto" align="left">
        <img src="',$options['base_avatar_url'],'/',$m_obj['avatar'],'.jpg?',$av_time,'" class="avatar" border="0" align="default" auto=""> &nbsp; 
        <img src="',$options['base_avatar_url'],'/',$m_obj['avatar'],'.jpg!normal?',$av_time,'" class="avatar" border="0" align="default" auto=""> &nbsp; 
        <img src="',$options['base_avatar_url'],'/',$m_obj['avatar'],'.jpg!mini?',$av_time,'" class="avatar" border="0" align="default" auto="">
        </td>
    </tr>
    <tr>
